...
Download the yaml file that contains the conda env: [baqcom.yaml]([https://github.com/hanielcedraz/newBAQCOM/blob/main/baqcom_env.yaml](https://github.com/hanielcedraz/miRbaqcom/blob/master/mirBaqcom_env.yaml))
